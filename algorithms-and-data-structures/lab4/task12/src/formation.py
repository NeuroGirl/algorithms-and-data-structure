...
if __name__ == '__main__':
    data = read_from_file(1, 'algorithms-and-data-structures/lab4/task12/txtf/input.txt')

    n, m, commands = data[0], data[1], data[2:]
    result = formation(n, commands)
    write_in_file('algorithms-and-data-structures/lab4/task12/txtf/output.txt', result)
