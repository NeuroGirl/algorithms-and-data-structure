...
if __name__ == '__main__':
    data = read_from_file('algorithms-and-data-structures/lab3/task5/txtf/input.txt')

    result = hirsch_index(data)

    write_in_file('algorithms-and-data-structures/lab3/task5/txtf/output.txt', [result])
